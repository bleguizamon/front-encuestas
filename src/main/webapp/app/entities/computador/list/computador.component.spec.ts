...
describe('Computador Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'computador', component: ComputadorComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.computadors?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to computadorService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getComputadorIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getComputadorIdentifier).toHaveBeenCalledWith(entity);
